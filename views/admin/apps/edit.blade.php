...
<h1 class="page-header">{{Lang::get('admin::apps.apps-edit')}}</h1>
{{ Form::open(array('url' => '/admin/apps/update', 'class'=>'form-horizontal form-submitable','files'=> true )) }}
	{{ Form::hidden('data[Apps][id]', $appObject->id) }}
	<div id="main-container" class="main-container">
		...
		<div class="control-group {{{ ($errors->first('name') ? 'has-error' : '') }}}">
			...
			<div class="controls">
				...
				{{ Form::text('data[Apps][name]', $appObject->name, array('class' => 'form-control')) }}
		...
		<div class="control-group {{{ ($errors->first('folder') ? 'has-error' : '') }}}">
			...
			<div class="controls">
				...
				{{ Form::text('data[Apps][folder]', $appObject->folder, array('class' => 'form-control','maxlength'=>20)) }}
		...
		<div class="control-group {{{ ($errors->first('description') ? 'has-error' : '') }}}">
			...
			<div class="controls">
				{{ Form::textarea('data[Apps][description]',$appObject->description, array('class' => 'form-control')) }}
		...
		<div class="control-group {{{ ($errors->first('sorting') ? 'has-error' : '') }}}">
			...
			<div class="controls">
				...
				{{ Form::text('data[Apps][sorting]', $appObject->sorting, array('class' => 'form-control textfield-very-shortly')) }}
		...
		<div class="control-group {{{ ($errors->first('status') ? 'has-error' : '') }}}">
			...
			<div class="controls">
				{{ Form::checkbox('data[Apps][status]', 1, $appObject->status ? true: false) }}
